    ...
    <div className="w-full max-w-md mx-auto py-20 px-4">
      <div className="text-center mb-10">
        <h1 className="text-4xl font-bold uppercase tracking-tighter text-black mb-2">
          {isLogin ? 'Welcome Back' : 'Join The Era'}
        </h1>
        <p className="text-gray-500 text-sm">
          {isLogin ? 'Enter your details to access your inner circle dashboard.' : 'Create an account to track orders and save your details.'}
        </p>
      </div>
      ...
      <div className="flex items-center mb-8">
        ...
        <span className="px-4 text-xs font-bold uppercase tracking-widest text-gray-400">Or use email</span>
        <div className="flex-grow border-t border-gray-200"></div>
      </div>
      ...
      <form onSubmit={handleAuth} className="flex flex-col space-y-6">
        ...
        <button 
          type="submit" 
          disabled={loading}
          className="w-full bg-black text-white py-5 font-bold uppercase tracking-widest text-sm hover:bg-brand-primary hover:text-black transition-all disabled:bg-gray-300 disabled:text-gray-500 mt-4 shadow-lg"
        >
