    ...
    <>
      <div className="flex flex-col lg:flex-row gap-12 lg:gap-24">
          ...
          <div className="flex md:flex-col gap-4 overflow-x-auto md:overflow-y-auto md:w-24 shrink-0 no-scrollbar">
            {product.images.map((img, idx) => (
              <button
                ...
                className={`relative aspect-[3/4] w-20 md:w-full shrink-0 overflow-hidden border-2 transition-all ${
        ...
        <div className="w-full lg:w-2/5 flex flex-col pt-4 md:pt-10">
                ...
                <div className="flex flex-wrap gap-3">
                  {uniqueColors.map((color) => (
                    <button
                      ...
                      className={`px-6 py-3 border text-sm font-bold uppercase tracking-widest transition-colors ${
                        selectedColor === color
              ...
              <div>
                <div className="flex justify-between mb-3">
                  ...
                  <button
                    ...
                    className="text-xs text-gray-400 hover:text-black underline underline-offset-4 uppercase tracking-wider transition-colors"
                  >
                    Size Guide
                  </button>
                </div>
                ...
                <div className="grid grid-cols-4 gap-3">
                  {uniqueSizes.map((size) => {
                    ...
                    const isSizeOutOfStock = variantForSize
                      ? variantForSize.stock_count <= 0
                      : true;
          ...
          {/* Description */}
          <div className="mt-12">
            <h3 className="text-sm font-bold uppercase tracking-widest mb-4 border-b border-gray-200 pb-2">
              Description
            </h3>
      ...
      {isSizeGuideOpen && (
        ...
        >
          {/* Modal Content */}
          <div
            className="relative w-full h-full max-w-6xl bg-white overflow-hidden shadow-2xl flex flex-col"
            onClick={(e) => e.stopPropagation()}
          >
            {/* Modal Header */}
            <div className="flex items-center justify-between px-5 py-4 md:px-8 border-b border-gray-200 shrink-0">
              <div>
                <p className="text-[10px] md:text-xs font-bold uppercase tracking-[0.25em] text-gray-400">
                  Reckless Era
                </p>
              ...
              <button
                ...
                className="w-10 h-10 flex items-center justify-center border border-gray-200 hover:bg-black hover:text-white hover:border-black transition-colors"
              >
                <X className="w-5 h-5" />
              </button>
            </div>
